...
import com.wrox.Attachment;
import com.wrox.Ticket;
...
public class TicketServlet extends HttpServlet {
    ...
    private void downloadAttachment(HttpServletRequest request, HttpServletResponse response) throws IOException {
        ...
        downloadAttachmentContents(attachment, response);
    }
...
//        ticket.setCustomerName(request.getParameter("customerName"));
    ...
    private void downloadAttachmentContents(Attachment attachment, HttpServletResponse response) throws IOException {
        ByteArrayInputStream inputStream = new ByteArrayInputStream(attachment.getContents());
        final byte[] bytes = new byte[4096];
